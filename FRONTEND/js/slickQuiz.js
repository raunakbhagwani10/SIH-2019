...
//if(localStorage.dlevel==null){
//localStorage.dlevel=0;
//}
//}
(function($){
    $.slickQuiz = function(element, options) {
        ...
        plugin.method = {
            ...
            completeQuiz: function(options) {
                ...
                // if(levelrank===1||levelRank===2||levelRank3===3||levelRank===4){
            ...
            calculateLevel: function(correctAnswers) {
				...
				w=localStorage.getItem('dlevel');
                if (plugin.method.inRange(0, 0.20, percent)) {
                    level = 4;
					//localStorage.dlevel = Number(localStorage.dlevel) + 1;
				...
				//if(w>0){
					...
					//localStorage.setItem('dlevel',w);
					//alert(localStorage.dlevel);
					window.location.href="starttask.html";
				//}
